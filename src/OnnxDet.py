...
EasYoloD.init('onnxdml', True)
model = EasYoloD.Model()
model.load('atkfp16.onnx', names=[1, 2, 3, 4, 5, 6, 7], conf=0.3, ious=0.5)
...
if __name__ == "__main__":
    ...
    # 创建检测器
    def dll_test():
        detector = OnnxDetector("D:\Code\Python\OnnxDetDll\OnnxDet.dll", "atkfp16.onnx", 0.3, 0.5)
